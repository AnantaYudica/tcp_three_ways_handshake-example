...
int main()
{
    ...
    a0_2 >>= 5;
    assert(a0[2] == std::uint8_t(0x11));
    assert(a0[3] == std::uint8_t(0x01));
    a0_1 <<= 9;
    assert(a0[0] == std::uint8_t(0x00));
    assert(a0[1] == std::uint8_t(0xAA));
    a0_2 += Bytes{{0xFF, 0x0E}};
    assert(a0[2] == std::uint8_t(0x10));
    assert(a0[3] == std::uint8_t(0x10));
    a0_1 -= Bytes{{0x11, 0x01}};
    assert(a0[0] == std::uint8_t(0xEF));
    assert(a0[1] == std::uint8_t(0xA8));
    a0_2 *= Bytes{{0x0E, 0x0E}};
    assert(a0[2] == std::uint8_t(0xE0));
    assert(a0[3] == std::uint8_t(0xC0));
    a0_1 /= Bytes{{0x0A}};
    assert(a0[0] == std::uint8_t(0xE4));
    assert(a0[1] == std::uint8_t(0x10));
    a0_2 %= Bytes{{0x11, 0x11}};
    assert(a0[2] == std::uint8_t(0x25));
    assert(a0[3] == std::uint8_t(0x05));
    Bytes a1{0x01, 0x02};
    Bytes a2{0x02, 0x01};
    Bytes a3{0x01, 0x02, 0x03, 0x04};
